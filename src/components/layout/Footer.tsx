    ...
    <footer className="bg-dark-forest text-cream">
      <div className="container-wide py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="w-11 h-11 rounded-xl bg-olive/30 border border-cream/20 flex items-center justify-center transition-all duration-300 hover:bg-terracotta hover:border-terracotta text-cream group"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-body text-sm font-semibold tracking-wide uppercase mb-5 text-warm-beige">
              Explore
            </h4>
