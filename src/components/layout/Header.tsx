      ...
      <nav className="container-wide flex items-center justify-between">
        ...
        <div className="hidden xl:flex items-center gap-4">
          ...
          <Button 
            ...
            className="bg-terracotta text-cream hover:bg-terracotta-dark border-0 font-semibold shadow-md"
          >
            Let's Talk
          </Button>
        </div>
          ...
          >
            <div className="container-wide py-6 flex flex-col gap-2">
              ...
              <Button 
                variant="hero" 
                size="lg" 
                className="mt-4 mx-4 bg-terracotta text-cream hover:bg-terracotta-dark border-0 font-semibold" 
                onClick={() => scrollToSection('#contact')}
              >
                Let's Talk
              </Button>
