        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.div 
              ...
              className="w-12 h-1 bg-terracotta mx-auto rounded-full origin-left" 
            />
          </motion.div>
          ...
          >
            ...
            >
              Rayven J. Moore is a <span className="text-dark-forest font-semibold">Certified Public Accountant</span> with 
            ...
            <motion.p
              ...
              transition={{ duration: 0.6, delay: 0.4 }}
            >
              A proud <span className="text-dark-forest font-semibold">University of Notre Dame alumnus</span> and longtime Houston resident, 
            ...
            >
              ...
              <span className="text-dark-forest font-medium"> clarity builds confidence, and confidence drives better outcomes.</span>
            </motion.p>
            ...
            <motion.div
              ...
              className="border-l-4 border-terracotta pl-6 py-4 my-8 bg-warm-beige/30 rounded-r-lg"
            >
              <p className="text-dark-forest font-medium italic text-xl">
