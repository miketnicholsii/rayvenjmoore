...
export default function CTASection() {
  return (
    <section id="cta" className="section-padding bg-warm-beige/30 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-0 right-0 w-1/2 h-full text-dark-forest"
      >
      ...
      <div className="container-narrow relative z-10">
        ...
        >
          ...
          >
            Ready to Start a{' '}
            <span className="text-terracotta font-bold">Meaningful Conversation</span>
          ...
          <motion.p 
            ...
            className="font-body text-lg text-olive max-w-xl mx-auto mb-10 leading-relaxed"
          >
